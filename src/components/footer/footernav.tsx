      ...
      <div className="w-full mt-28  mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="flex flex-col gap-4 items-center md:items-start text-center md:text-left">
            <h3 className="text-[24px] font-sans mb-3">{t("Home.name")}</h3>
            <ul className="space-y-2 flex flex-col gap-4 text-gray-400 text-[20px] font-sans">
              <li>
          ...
          {/* Our Clients Section */}
          <div className="flex flex-col gap-4 items-center md:items-start text-center md:text-left">
            <h3 className="text-[24px] font-sans mb-3">{t("OurClients.name")}</h3>
            <ul className="space-y-2 flex flex-col gap-4 text-gray-400 text-[20px] font-sans">
              <li>
          ...
          <div className="flex flex-col gap-4 items-center md:items-start text-center md:text-left">
            <h3 className="text-[24px] font-sans mb-3">{t("FollowUs.name")}</h3>
            <ul className="space-y-2 flex flex-col gap-4 text-gray-400 text-[20px] font-sans">
              <li>
          ...
          {/* Location Section */}
          <div className="flex flex-col gap-4 items-center md:items-start text-center md:text-left">
            <h3 className="text-[24px] font-sans mb-3">{t("Location.name")}</h3>
            <ul className="space-y-2 flex flex-col gap-4 text-gray-400 text-[20px] font-sans">
